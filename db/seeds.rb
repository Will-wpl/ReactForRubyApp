...
email_templates = [
    ...
    {subject:'Admin has responded to your deviation request.', body:'Dear #user.company_name,<br/><br/>Admin has responded to your deviation request.<br/><br/>Please proceed to view the response and manage deviation request at <a href="http://revv.sg">revv.sg</a>.', template_type: '9'}
]
