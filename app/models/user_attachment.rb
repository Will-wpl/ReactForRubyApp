class UserAttachment < ApplicationRecord
  ...
  FileType_Letter_Authorisation_Buyer = 'LETTER_OF_AUTHORISATION_BUYER'.freeze
  FileType_Letter_Authorisation_Retailer = 'LETTER_OF_AUTHORISATION_RETAILER'.freeze
