class PdfAggregateConsumption
  ...
  def aggregate
    ...
    push_colume_data({:total_row => total_row, :head_row => head_row, :peak_row => peak_row, :off_peak_row => off_peak_row, :title => 'HT(Small)', :peak => auction_contract.total_hts_peak, :off_peak => auction_contract.total_hts_off_peak})

    push_colume_data({:total_row => total_row, :head_row => head_row, :peak_row => peak_row, :off_peak_row => off_peak_row, :title => 'HT(Large)', :peak => auction_contract.total_htl_peak, :off_peak => auction_contract.total_htl_off_peak})
