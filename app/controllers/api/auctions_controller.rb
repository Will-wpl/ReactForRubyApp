class Api::AuctionsController < Api::BaseController
  ...
  def unpublished
    ...
    actions = [{ url: '/api/admin/auctions/new', name: 'Edit', icon: 'lm--icon-search' , interface_type: 'auction' },
               { url: '/api/admin/auctions/:id', name: 'Delete', icon: 'lm--icon-search' , interface_type: 'auction' }]
