class Api::AuctionsController < Api::BaseController
  ...
  def get_auction_details(auction)
    ...
    auction_result_contracts = AuctionResultContract.find_by_auction_id(auction.id)
    auction_json[:auction_result_contracts] = auction_result_contracts.blank? ? [] : auction_result_contracts.sort_by {|contract| contract.contract_duration.to_i}
    auction_json
  end
