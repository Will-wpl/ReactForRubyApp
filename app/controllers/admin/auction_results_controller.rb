class Admin::AuctionResultsController < Admin::BaseController
  ...
  private
    ...
    #
    # def model_params
    #   params.require(:auction_history).permit(:reserve_price, :lowest_average_price, :status, :lowest_price_bidder, :contract_period_start_date, :contract_period_end_date, :total_volume, :total_award_sum, :lt_peak, :lt_off_peak, :hts_peak, :hts_off_peak, :htl_peak, :htl_off_peak, :user_id, :auction_id)
    # end
    #
