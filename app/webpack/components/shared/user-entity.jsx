                        ...
                        <div key={i} style={{ marginTop: '20px', marginBottom: '20px', }} id={i}>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input id={it.user_company_name} type="text" name="company_name" value={it.user_company_name} onChange={this.Change.bind(this, 'company_name', i)} disabled={this.state.disabled} ref="company_name" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="company_uen" value={it.user_company_uen} onChange={this.Change.bind(this, 'company_uen', i)} disabled={this.state.disabled} ref="company_uen" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="company_address" value={it.user_company_address} onChange={this.Change.bind(this, 'company_address', i)} disabled={this.state.disabled} ref="company_address" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="billing_address" value={it.user_billing_address} onChange={this.Change.bind(this, 'billing_address', i)} disabled={this.state.disabled} ref="billing_address" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="bill_attention_to" value={it.user_bill_attention_to} onChange={this.Change.bind(this, 'bill_attention_to', i)} disabled={this.state.disabled} ref="bill_attention_to" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="contact_name" value={it.user_contact_name} onChange={this.Change.bind(this, 'contact_name', i)} disabled={this.state.disabled} ref="contact_name" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="contact_email" value={it.user_contact_email} onChange={this.Change.bind(this, 'contact_email', i)} disabled={this.state.disabled} ref="contact_email" aria-required="true" title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="contact_mobile_no" value={it.user_contact_mobile_no} onChange={this.Change.bind(this, 'contact_mobile_no', i)} disabled={this.state.disabled} ref="contact_mobile_no" aria-required="true" maxLength="8" placeholder="Number should contain 8 integers." title="Please fill out this field"></input>
                            ...
                            <div className="lm--formItem lm--formItem--inline string">
                                ...
                                <div className="lm--formItem-right lm--formItem-control">
                                    <input type="text" name="contact_office_no" value={it.user_contact_office_no} onChange={this.Change.bind(this, 'contact_office_no', i)} disabled={this.state.disabled} ref="contact_office_no" aria-required="true" maxLength="8" placeholder="Number should contain 8 integers." title="Please fill out this field"></input>
