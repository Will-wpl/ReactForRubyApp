...
export class Modal extends React.Component {
    ...
    componentWillReceiveProps(next) {
        ...
        if (next.attatchment) {
            ...
            this.setState({
                operatinType:next.operatinType
            })
            console.log(this.state.operatinType)
        }
        if (next.advisory) {
            this.setState({
        ...
        if (this.props.listdetail) {
            ...
            if (this.props.listdetailtype === 'Documents Message') {
                showDetail = <ul className="showdetail">
                    ...
                    <li>1) Duly signed <a href={(this.state.attatchment_file_path != "" && this.state.attatchment_file_path !== null) ? this.state.attatchment_file_path : "javascript:void(0)"} download={this.state.attatchment_file_name} className="urlStyleUnderline" target="_blank">Declaration Form</a>.</li>
                    ...
                    <li>4) A copy of the Authorised Representative's NRIC/Employment pass (Front Side only) or Passport Particulars Page.</li>
