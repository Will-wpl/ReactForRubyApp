...
export default class CheckboxListItem extends Component {
    ...
    render() {
        return (
            <li className="checkitem" onMouseOver={this.showTitle.bind(this,this.props.index)} onMouseLeave={this.hideTitle.bind(this,this.props.index)} onClick={this.onItemClick.bind(this, this.props.id, !this.state.status, this.props.color)} style={{ cursor: 'pointer' }}>
