            ...
            <div>
                {
                    ...
                    return <div key={index}>
                             ...
                             <table className="retailer_fill u-mb3" cellPadding="0" cellSpacing="0">
                                 <tbody>
                                     <tr><td>Accound Number</td><td><input type="text" defaultValue={`${item.number}${index+1}`} id={"number"+(index+1)} required aria-required="true" name={"number"+(index+1)}/></td></tr>
                                     ...
                                     <tr><td>Peak Volume (kWh/mouth)</td><td><input type="text" required aria-required="true" name={"peak"+(index+1)} id={"peak"+(index+1)} defaultValue={item.peak}/></td></tr>
                                     <tr><td>Off-peak Volume (kWh/mouth)</td><td><input type="text" required aria-required="true" name={"off_peak"+(index+1)} defaultValue={item.off_peak} id={"off_peak"+(index+1)}/></td></tr>
                                 </tbody>
                             </table>
                          </div>
                    }) 
