                ...
                <div className="col-sm-12 col-md-6 push-md-3">
                    ...
                    <div className="lm--formItem lm--formItem--inline string">
                        ...
                        <div className="lm--formItem-right lm--formItem-control">
                            <input type="text" name="buyer_email" value={this.state.buyer_email} onChange={this.Change.bind(this,'buyer_email')} disabled={this.state.disabled} ref="buyer_email" maxLength="50" required aria-required="true" pattern="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" title="Email address should be in the format name@example.com."/>
                        </div>
                    </div>
                    <div className="lm--formItem lm--formItem--inline string">
                        <label className="lm--formItem-left lm--formItem-label string required">
