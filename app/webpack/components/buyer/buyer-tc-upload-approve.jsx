            ...
            <div>
                <div className="live_modal_approve_attachment">
                    <div className="attachment">
                        ...
                        {this.state.epaIsExist ? <div><h4 className="lm--formItem lm--formItem--inline string checkBuyer"><input type="checkbox" id="chkEPA" onChange={this.Change.bind(this, 'chkEPA')} required /><span>Check here to indicate that you have read and agree to the latest Electricity Purchase Contract. </span></h4>
                            <div id="chkEPA_message" className="isPassValidate" style={{ marginLeft: "33px" }}>Please check this box if you want to proceed.</div>
                        </div> : <div></div>}
                        {this.state.bptIsExist ? <div><h4 className="lm--formItem lm--formItem--inline string checkBuyer"><input type="checkbox" id="chkBPT" onChange={this.Change.bind(this, 'chkBPT')} required /><span>Check here to indicate that you have read and agree to the latest Terms & Conditions of Use (Buyer). </span></h4>
                            <div id="chkBPT_message" className="isPassValidate" style={{ marginLeft: "33px" }}> Please check this box if you want to proceed.</div>
                        </div> : <div></div>}
                        <br/>
                        <h4>The amended {this.state.epaIsExist?"Electricity Purchase Contract":""} {this.state.bptIsExist && this.state.epaIsExist?"&":""} {this.state.epaIsExist?"Terms & Conditions of Use (Buyer)":""} will not be applicable to (i) upcoming Reverse Auctions that you have already been invited to participate in, (ii) Reverse Auctions that are in progress, and (iii) Reverse Auctions that had already been completed.</h4>
