    ...
    render () {
        return (
            <div>
                ...
                <h4 className="u-mb3"><input name="agree_auction" type="checkbox" disabled={this.state.disabled} required /> I agree to the <a href={this.state.link}>terms and conditions.</a></h4>
