                                        ...
                                        this.state.site_list.map((item, index) => {
                                            return <tr key={index}>
                                                ...
                                                <td className="left">
                                                    ...
                                                    <div><span>Peak: </span><span><span>{parseInt(item.totals * (item.peak_pct) / 100)} kWh/month </span>({parseFloat(item.peak_pct).toFixed(2)}%</span>)<span style={{ fontWeight: "bold", fontSize: "14px" }} title="Off Peak is auto calculated by 1-Peak." >&nbsp;&nbsp;?</span></div>
                                                    <div><span>Off-Peak: </span><span>{item.totals - parseInt(item.totals * (item.peak_pct) / 100)} kWh/month </span><span>({parseFloat(100 - item.peak_pct).toFixed(2)}%)</span></div>
