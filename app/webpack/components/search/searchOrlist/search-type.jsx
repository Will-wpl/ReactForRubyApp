            ...
            <div className="search_type">
                <dl className="lm--formItem string optional">
                    ...
                    <dd>
                        ...
                        {this.props.type == "Buyer List"?<button className="lm--button lm--button--primary reset_btn" onClick={this.goDeleteList.bind(this,'del_buyers')}>Buy Deleted List</button>:""}
                    </dd>
