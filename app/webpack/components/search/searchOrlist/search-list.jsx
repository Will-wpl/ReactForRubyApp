                                                                ...
                                                                item.contracts ? item.contracts.map((k, s) => {
                                                                    ...
                                                                    : <abbr>{
                                                                        ...
                                                                        : (
                                                                            ...
                                                                            ? moment(item[`${it.field_name}`]).format('D MMM YYYY') : (item[`${it.field_name}`] ? (item[`${it.field_name}`].indexOf("!") > 0 ? <bdo>{item[`${it.field_name}`].split("!")[0]} <b title="Purchasing Entity Pending" style={{ "color": "red" }}>!</b></bdo> : item[`${it.field_name}`]) : null))}</abbr>
                                                            }
                                                        </td>
                                                    }
