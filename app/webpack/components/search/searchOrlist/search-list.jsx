                                                            ...
                                                            return <td key={i}>
                                                                {
                                                                    ...
                                                                    ? moment(item[`${it.field_name}`]).format('D MMM YYYY hh:mm A'):(item[`${it.field_name}`].indexOf("!")>0?<span>{item[`${it.field_name}`].split("!")[0]} <font title="Purchasing Entity Pending" style={{"color":"red"}}>!</font></span>:item[`${it.field_name}`])}</abbr>
                                                                }
                                                                </td>
                                                        }
