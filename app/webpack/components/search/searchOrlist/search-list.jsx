                                                                ...
                                                                return <td key={i}>
                                                                        {item.contracts.map((e,l)=>{
                                                                            if(e.report != "" || e.log != "" || e.award != ""){
                                                                                return <abbr key={l}>{e[`${it.field_name}`]?<a className={it.field_name} href={e[`${it.field_name}`]?"/"+e[`${it.field_name}`]:"javascript:void(0);"} onClick={this.saveId.bind(this,e[`${it.field_name}`])}></a>:''}</abbr>
                                                                            }
                                                                        })}
                                                                </td>
                                                            }else{
