            ...
            <div className="col-sm-12 col-md-8 push-md-2">
                ...
                <div className="lm--formItem lm--formItem--inline string">
                    ...
                    <div className="lm--formItem-right lm--formItem-control u-grid mg0">
                        <UploadFile type="SELLER_BUYER_TC" required="required" showlist={false} fileData={this.state.fileData.SELLER_BUYER_TC} propsdisabled={false} uploadUrl={this.state.uploadUrl} />
                ...
                <div className="lm--formItem lm--formItem--inline string">
                    ...
                    <div className="lm--formItem-right lm--formItem-control u-grid mg0">
                        <UploadFile type="SELLER_REVV_TC" required="required" showlist={false} fileData={this.state.fileData.SELLER_REVV_TC} propsdisabled={false}  uploadUrl={this.state.uploadUrl}/>
                        <div className="col-sm-12 col-md-2 u-cell">
                ...
                <div className="lm--formItem lm--formItem--inline string">
                    ...
                    <div className="lm--formItem-right lm--formItem-control u-grid mg0">
                        <UploadFile type="BUYER_REVV_TC" required="required" showlist={false} fileData={this.state.fileData.BUYER_REVV_TC} propsdisabled={false}  uploadUrl={this.state.uploadUrl}/>
                        <div className="col-sm-12 col-md-2 u-cell">
