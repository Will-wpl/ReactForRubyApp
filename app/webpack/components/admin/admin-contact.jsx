        ...
        return (
            <div className="u-grid admin_invitation">
                <div className="col-sm-12 col-md-8 push-md-2">
                    ...
                    {/* <div className="lm--formItem lm--formItem--inline string">
                        <label className="lm--formItem-left lm--formItem-label string required">
                            <abbr title="required">*</abbr> Tenent - Manage T&C :
                    </label>
                        <div className="lm--formItem-right lm--formItem-control u-grid mg0">
                            <UploadFile type="TENENT_MANAGE_TC" required="required" validate={this.state.validate} showList="2" col_width="10" showWay="0" fileData={this.state.fileData.TENENT_MANAGE_TC} propsdisabled={false} uploadUrl={this.state.uploadUrl} />
                            <div className="col-sm-12 col-md-2 u-cell">
                                <button className="lm--button lm--button--primary" onClick={this.show_history.bind(this, 'TENENT_MANAGE_TC')} >History</button>
                            </div>
                        </div>
                    </div> */}
                </div>
