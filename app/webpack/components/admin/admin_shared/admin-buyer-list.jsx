                                        ...
                                        this.props.dashboard.list.map((item, index) => {
                                            return (
                                                <li key={index} className="u-grid">
                                                    ...
                                                    <span id="showDetail" className={item.participation_status === '1' ? "col-sm-4" : item.accept_status === '0' ? "col-sm-2" : "col-sm-2 isHide"} onClick={this.showDetail.bind(this, item)}>Consumption Details {item.accept_status === "1" ? "(Approved)" : item.accept_status === "0" ? "(Rejected)" : ""}</span>
                                                </li>)
                                        })
                                    }
                                </ul>
