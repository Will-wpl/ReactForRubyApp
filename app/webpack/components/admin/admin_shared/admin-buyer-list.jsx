                                        ...
                                        this.props.dashboard.list.map((item, index) => {
                                            return (
                                                <li key={index} className="u-grid">
                                                    ...
                                                    <span id="showDetail" className={item.participation_status === '1' ? "col-sm-4" : item.accept_status === '0' ? "col-sm-4" : "col-sm-4 isHide"} style={{ "textAlign":"left","paddingLeft":"20px"}} onClick={this.showDetail.bind(this, item)}><font>Consumption Details</font> {item.accept_status === "1" ? <b className={"b_approved"}>(Admin Approved)</b> : item.accept_status === "0" ? <b className={"b_rejected"}>(Admin Rejected)</b> : ""}</span>
                                                </li>)
                                        })
                                    }
                                </ul>
