            ...
            <div className={styleType}>
                ...
                <dl className="vw-block vw-block-cols creatRa">
                    ...
                    <dd className="lm--formItem lm--formItem--inline string optional">
                        ...
                        <label className="lm--formItem-right lm--formItem-control">
                        <DatePicker selected={this.state.start_datetime} disabled={this.state.disabled} ref="start_datetime" shouldCloseOnSelect={true} name="start_datetime" showTimeSelect dateFormat="YYYY-MM-DD HH:mm" timeFormat="HH:mm" timeIntervals={5}  className="time_ico"  onChange = {this.timeChange} minDate={moment()} maxDate={moment().add(30, "days")} title="Time must not be in the past."  required aria-required="true"/>
                    ...
                    <dd className="lm--formItem lm--formItem--inline string optional">
                        ...
                        <label className="col"><DatePicker disabled={this.state.disabled} shouldCloseOnSelect={true} required aria-required="true" ref="contract_period_start_date" name="contract_period_start_date" className="date_ico" dateFormat="YYYY-MM-DD" selected={this.state.startDate} selectsStart startDate={this.state.startDate} endDate={this.state.endDate} onChange = {this.starttimeChange}/>
                        {/* <abbr className="error-block"  ref="ra_time_start_error">{this.state.ra_time_start_error}</abbr> */}
                        </label>
                        <label className="col"><b>to</b></label>
                        <label className="col"><DatePicker disabled={this.state.disabled} shouldCloseOnSelect={true} required aria-required="true" ref="contract_period_end_date" name="contract_period_end_date" className="date_ico" dateFormat="YYYY-MM-DD" selected={this.state.endDate} selectsEnd startDate={this.state.startDate} endDate={this.state.endDate}  onChange = {this.endtimeChange}/>
