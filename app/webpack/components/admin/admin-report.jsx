                    ...
                    <div className="col-sm-12 col-md-5">
                        ...
                        <table className="retailer_fill" cellPadding="0" cellSpacing="0">
                            ...
                            <tr>
                                ...
                                <td >{this.state.consumption.total_lt_peak}$/kWh</td>
                                <td >{this.state.consumption.total_hts_peak}$/kWh</td>
                                <td >{this.state.consumption.total_htl_peak}$/kWh</td>
                                <td >{this.state.consumption.total_eht_peak}$/kWh</td>
                            </tr>
                            <tr>
                                <td>Off-Peak<br/>(7pm-7am)</td>
                                <td >{this.state.consumption.total_lt_off_peak}$/kWh</td>
                                <td >{this.state.consumption.total_hts_off_peak}$/kWh</td>
                                <td >{this.state.consumption.total_htl_off_peak}$/kWh</td>
                                <td >{this.state.consumption.total_eht_off_peak}$/kWh</td>
                            </tr>
                            </tbody>
                        </table>
                        </div>
