    ...
    render() {
        ...
        return (
            <div>
                ...
                <Modal formSize="middle" modalSize="big" text={this.state.text} acceptFunction={this.changeEmail.bind(this)} listdetail={this.state.listdetail}  listdetailtype="Email Template" ref="Modal" />
            </div>
