                                                            ...
                                                            this.state.step.map((it,i)=>{
                                                                ...
                                                                return <td key={i}>{
                                                                                ...
                                                                                (item.detail.current.current_node === it ? 
                                                                                    ...
                                                                                    (item.detail.current.current_status === '3' ? <abbr className="step_finished" onClick={item.detail.current.turn_to_role === 2?this.manage_contact.bind(this,item.arrangement_id,item.company_name,false):this.manage_contact.bind(this,item.arrangement_id,item.company_name,true)}></abbr> ://3 admin accept
