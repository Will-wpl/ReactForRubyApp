        ...
        return (
            <div className="live_modal_approve_attachment">
                <div className="attachment">
                    ...
                    <br/>
                    <h4>The amended {this.state.epaIsExist?"Electricity Purchase Contract":""} {this.state.bptIsExist && this.state.epaIsExist?"&":""} {this.state.epaIsExist?"Terms & Conditions of Use (Retailer)":""} will not be applicable to (i) upcoming auctions that you have already been invited to participate in, (ii) auctions that are in progress, and (iii) auctions that had already been completed.</h4>
                    <br/>
                </div>
