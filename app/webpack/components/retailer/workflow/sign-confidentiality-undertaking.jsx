    ...
    render(){
        return(
            <div className="sign_box">
                ...
                <p>{this.props.auction.step===3? 'You are bounded by the  <a className="download_ico" target="_blank" download={this.state.file.length>0?this.state.file[0].file_name:""} href={this.state.file.length>0?this.state.file[0].file_path:"#"}>Retailer Platform Terms of Use</a> and <a className="download_ico" target="_blank" download={this.state.file.length>0?this.state.file[1].file_name:""} href={this.state.file.length>0?this.state.file[1].file_path:"#"}>Electricity Procurement Agreement.</a>': 'You are bounded by the confidentiality clauses in the <a className="download_ico" target="_blank" download={this.state.file.length>0?this.state.file[0].file_name:""} href={this.state.file.length>0?this.state.file[0].file_path:"#"}>Retailer Platform Terms of Use</a> '}</p>
