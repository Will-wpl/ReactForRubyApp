...
export class Proposedeviations extends React.Component{
    ...
    Withdraw(obj){
        ...
        retailerWithdraw(this.props.current.current.arrangement_id,{id:obj.id,propose_deviation:decodeURI(this.state.deviations_list[obj.index].propose_deviation)}).then(res=>{
            this.refs.Modal.showModal();
            this.setState({
