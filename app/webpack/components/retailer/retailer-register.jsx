                        ...
                        <div className="u-grid admin_invitation">
                            <div className="col-sm-12 col-md-6 push-md-3">
                                ...
                                <div className="lm--formItem lm--formItem--inline string">
                                    ...
                                    <div className="lm--formItem-right lm--formItem-control">
                                        <UploadFile type="RETAILER_DOCUMENTS" required="required" showList="1" col-width="12" showWay="2" fileData={this.state.fileData.RETAILER_DOCUMENTS} propsdisabled={false} uploadUrl={this.state.uploadUrl} />
                                    </div>
                                </div>
