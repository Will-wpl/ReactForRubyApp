...
export const searchTypeData = {
    ...
    "Select Individual Buyers":{
        ...
        list_data:[
            ...
            {title:"Status:",type:"approval_status",species:"select",operator:'=',options:[{option:"All",value:""},{option:"Not invited",value:"0"},{option:"pending sent",value:"2"},{option:"Notification sent",value:"3"},{option:"Invited",value:"1"}]},
