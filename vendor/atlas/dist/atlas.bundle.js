...
var Toggle = function () {
  function Toggle(element, options) {
    ...
    this.options = (0, _assign2.default)({}, Toggle.options, options);
    this.open = false;
  }
...
var _mobileNav = __webpack_require__(59);

var _mobileNav2 = _interopRequireDefault(_mobileNav);

var _searchToggle = __webpack_require__(101);
...
var _lumimap = __webpack_require__(114);

var _lumimap2 = _interopRequireDefault(_lumimap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// import fonts
// polyfills
var requireImages = __webpack_require__(116);
...
Atlas.MobileNav = _mobileNav2.default;
Atlas.SearchToggle = _searchToggle2.default;
Atlas.Dropdown = _dropdown2.default;
Atlas.Tabs = _tabs2.default;
Atlas.Alert = _alert2.default;
Atlas.LumiMap = _lumimap2.default;
...
var MobileNav = function (_Toggle) {
  (0, _inherits3.default)(MobileNav, _Toggle);

  function MobileNav(element) {
    (0, _classCallCheck3.default)(this, MobileNav);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MobileNav.__proto__ || (0, _getPrototypeOf2.default)(MobileNav)).call(this, element, MobileNav.options));
  ...
  (0, _createClass3.default)(MobileNav, [{
    key: '_init',
    value: function _init() {
      (0, _get3.default)(MobileNav.prototype.__proto__ || (0, _getPrototypeOf2.default)(MobileNav.prototype), '_init', this).call(this);
      if (this.element.querySelector(MobileNav.options.selectorTrigger)) {
        this._setInnerText(this._getIsActiveInnerHTML());
      }
    }
  }, {
    key: '_getIsActiveInnerHTML',
    value: function _getIsActiveInnerHTML() {
      return this.element.querySelector(MobileNav.options.classActiveLink).innerHTML;
    }
  }, {
    key: '_setInnerText',
    value: function _setInnerText(text) {
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(24)(Function.call, __webpack_require__(36).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var SearchToggle = function (_Toggle) {
  (0, _inherits3.default)(SearchToggle, _Toggle);

  function SearchToggle(element) {
    (0, _classCallCheck3.default)(this, SearchToggle);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SearchToggle.__proto__ || (0, _getPrototypeOf2.default)(SearchToggle)).call(this, element, SearchToggle.options));

    _this.field = _this.element.querySelector(_this.options.selectorField);
    _this._init();
    return _this;
  }

  (0, _createClass3.default)(SearchToggle, [{
    key: '_init',
    value: function _init() {
      (0, _get3.default)(SearchToggle.prototype.__proto__ || (0, _getPrototypeOf2.default)(SearchToggle.prototype), '_init', this).call(this);
      // handle field blur
    ...
    key: '_handleFieldClick',
    value: function _handleFieldClick(event) {
    ...
    key: '_open',
    value: function _open() {
      (0, _get3.default)(SearchToggle.prototype.__proto__ || (0, _getPrototypeOf2.default)(SearchToggle.prototype), '_open', this).call(this);
      this.field.focus();
    }
  }]);
  return SearchToggle;
...
var Dropdown = function (_Toggle) {
  (0, _inherits3.default)(Dropdown, _Toggle);

  function Dropdown(element) {
    (0, _classCallCheck3.default)(this, Dropdown);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Dropdown.__proto__ || (0, _getPrototypeOf2.default)(Dropdown)).call(this, element, Dropdown.options));
...
var Tabs = function () {
  function Tabs(element) {
    ...
    this.element = element;
    this.tabs = (0, _from2.default)(element.querySelectorAll(Tabs.options.selectorTab));
    this.links = this.tabs.map(function (tab) {
      return tab.querySelector(Tabs.options.selectorLink);
    });
    this.hashes = this.links.map(function (link) {
      var href = link.getAttribute('href');
      // if href is fully-qualified url, null is pushed instead
      return href[0] === '#' ? href : null;
    });
    this.panes = this.links.map(function (link) {
  ...
  (0, _createClass3.default)(Tabs, [{
    ...
    */
    ...
    value: function getStartingIndex() {
      // 1. look for url #hash
      var urlHash = this.hashes.indexOf(window.location.hash);
      if (urlHash > -1) return urlHash;

      // 2. look for active nav item
      var navIndex = this.tabs.findIndex(function (tab) {
        return tab && tab.classList.contains(Tabs.options.classActive);
      });
      if (navIndex > -1) return navIndex;

      // 3. look for active pane
      var paneIndex = this.panes.findIndex(function (pane) {
        return pane && pane.classList.contains(Tabs.options.classActive);
      });
    ...
    */
    ...
    key: '_selectTab',
    value: function _selectTab(index) {
      var newTab = this.tabs[index];
      this.tabs.forEach(function (tab) {
        return tab.classList.remove(Tabs.options.classActive);
      });
...
var Alert = function () {
  function Alert(element, options) {
    ...
    this.element = element;
    this.options = (0, _assign2.default)({}, Alert.options, options);
    this._init();
  }
...
var _loadGoogleMapsApi = __webpack_require__(115);

var _loadGoogleMapsApi2 = _interopRequireDefault(_loadGoogleMapsApi);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var LumiMap = function () {
  function LumiMap(element, options) {
    (0, _classCallCheck3.default)(this, LumiMap);
    ...
    domReady(function () {
      ...
      if (this.element) {
        this.options = (0, _assign2.default)({}, LumiMap.options, options);
        this.options.mapOptions = (0, _assign2.default)({}, LumiMap.options.mapOptions, options.mapOptions);
        this._init();
      }
    }.bind(this));
  }

  (0, _createClass3.default)(LumiMap, [{
    key: '_init',
    value: function _init() {
      var _this = this;

      LumiMap.loader = LumiMap.loader || (0, _loadGoogleMapsApi2.default)(this.options.apiOptions);
      LumiMap.loader.then(function (googleMaps) {
        _this.GoogleMaps = _this.GoogleMaps || googleMaps;
        _this._setupMap();
        if (_this.options.markers && _this.options.markers.length > 0) {
          _this._placeMarkers();
        }
      }).catch(function (err) {
        console.error(err);
    ...
    key: '_generateCircleIcon',
    value: function _generateCircleIcon(point) {
      var size = point.size || 10; // default circle size (diameter) in px
...
var map = {
	"./logo-horizontal-dark.png": 117,
	"./logo-sp-notext.png": 118,
	"./logo.png": 119
};
...
module.exports = "/dist/images/logo-horizontal-dark.png";

/***/ }),
/* 118 */
/***/ (function(module, exports) {

module.exports = "/dist/images/logo-sp-notext.png";

/***/ }),
/* 119 */
/***/ (function(module, exports) {

module.exports = "/dist/images/logo.png";
