SimpleForm.setup do |config|
  config.wrappers :horizontal_collection_select_input, tag: 'div', class: 'lm--formItem lm--formItem--inline', error_class: 'is-error' do |wr|
    wr.use :html5
    ...
    wr.wrapper tag: 'div', class: 'lm--formItem-right lm--formItem-control' do |wr_in|
      wr_in.use :input, class: 'lm--select'
