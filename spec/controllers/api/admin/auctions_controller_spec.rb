...
RSpec.describe Api::Admin::AuctionsController, type: :controller do
  ...
  describe 'GET pdf' do
    before :each do
      ...
      @rich_template = create(:rich_template, content: File.read(Rails.root.join('app', 'assets', 'templates', 'letter_of_award_template.html')), type: 1)
      @rich_template2 = create(:rich_template, content: File.read(Rails.root.join('app', 'assets', 'templates', 'letter_of_award_template.html')), type: 2)
      ...
      @consumption_test = create(:consumption, action_status:1,participation_status:1,lt_peak:10000.0,lt_off_peak:10000.0,hts_peak:10000.0,hts_off_peak:10000.0,htl_peak:10000.0,htl_off_peak:10000.0,user:@user4,auction: @auction_test,created_at: '2018-02-07T06:49:47.698736' ,updated_at: '2018-03-09T02:24:36.338668' ,eht_peak:10000.0,eht_off_peak:10000.0,acknowledge:1, contract_duration: 12)
      create(:consumption, action_status:1,participation_status:2,user:@user5,auction: @auction_test,created_at: '2018-02-07T06:49:48.04069' ,updated_at: '2018-02-07T06:49:48.04069', contract_duration: 12)
      create(:consumption, action_status:1,participation_status:2,user:@user6,auction: @auction_test,created_at: '2018-02-07T06:49:52.993281' ,updated_at: '2018-02-07T06:49:52.993281', contract_duration: 12)
      create(:consumption, action_status:1,participation_status:2,user:@user7,auction: @auction_test,created_at: '2018-02-07T06:49:53.377232' ,updated_at: '2018-02-07T06:49:53.377232', contract_duration: 12 )

      @entity1 = create(:company_buyer_entity, user_id:@user4.id, company_name: 'company_name', company_address: 'company_address', company_uen: 'company_uen23423423')
    ...
    context 'GET letter of award pdf' do
      it 'admin letter of award pdf', pdf: true do
        ...
        expect(get: "/api/admin/auctions/letter_of_award_pdf?auction_id=#{@auction_test.id.to_s}&user_id=#{@user4.id}&entity_id=#{@entity1.id}").to be_routable

        get :letter_of_award_pdf, params: {auction_id: @auction_test.id, user_id: @user4.id, contract_duration: 12, entity_id: @entity1.id}
