...
RSpec.describe BidJob, type: :job do
  ...
  #     end_time = six_month_contract.contract_period_end_date
  #     calculate_dto = CalculateDto.new
  ...
  #     calculate_dto.lt_peak = 0.1777
  #     calculate_dto.lt_off_peak = 0.1777
  #     calculate_dto.hts_peak = 0.1777
  #     calculate_dto.hts_off_peak = 0.1777
  #     calculate_dto.htl_peak = 0.1777
  #     calculate_dto.htl_off_peak = 0.1777
  #     calculate_dto.eht_peak = 0.1777
  #     calculate_dto.eht_off_peak = 0.1777
  #     calculate_dto.user_id = retailer_user.id
  #     calculate_dto.auction_id = auction.id
